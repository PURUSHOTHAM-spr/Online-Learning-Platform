      ...
      <div className="flex h-auto w-full max-w-275 overflow-hidden rounded-3xl bg-white shadow-2xl lg:h-190">
        ...
        <div className="flex w-full flex-col justify-center px-8 py-10 lg:w-1/2 lg:px-16">
          <div className="mb-8 text-center lg:text-left">
            <h1 className="text-4xl font-bold text-[#1e293b]">Create account</h1>
            <p className="mt-2 text-[#64748b]">Start learning for free today</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`flex w-full items-center justify-center gap-2 rounded-xl bg-[#1e293b] py-4 text-base font-bold text-white shadow-lg transition hover:bg-[#0f172a] active:scale-[0.98] ${isLoading ? "cursor-not-allowed opacity-70" : ""}`}
            >
              {isLoading ? (
